...
# Example usage and feature scaling strategy
...
# Advanced feature engineering ideas for future scaling
class FeatureEngineer:
    """
    Class to handle feature engineering as you scale
    """
    
    @staticmethod
    def add_technical_indicators(df: pd.DataFrame, price_col: str = 'close'):
        ...
        # Volatility
        df['volatility'] = df[price_col].pct_change().rolling(20).std()
        
        return df
    
    @staticmethod
    def add_external_features(df: pd.DataFrame):
        """Placeholder for external features like market indices, etc."""
        # This is where you'd add S&P 500, Gold prices, VIX, etc.
        # df['sp500'] = ... 
        # df['gold_price'] = ...
        # df['vix'] = ...
        pass
...
if __name__ == "__main__":
    ...
    # Demonstrate additional checkpointing features
    print("\n" + "=" * 40)
    print("🔍 ADDITIONAL CHECKPOINTING FEATURES")
    print("=" * 40)
    ...
    # Show how to load a trained model (example)
    print("\n💡 Example: Loading a trained model")
    print("   model, model_data = load_trained_model('.outputs/price_only/final_model_*.pth')")
    print("   # Use model for predictions...")
    
    print("\n🎯 Next steps:")
    print("   1. Replace sample data with real Bitcoin data")
    print("   2. Experiment with different hyperparameters")
    print("   3. Resume training from checkpoints if needed")
    print("   4. Use saved models for production predictions")